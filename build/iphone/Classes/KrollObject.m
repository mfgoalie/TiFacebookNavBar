 ...
 * Copyright (c) 2009-2011 by FacebookNavBarViewExample, Inc. All Rights Reserved.
...
//@interface FacebookNavBarViewExampleObject : NSObject
//@end

@interface FacebookNavBarViewExampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FacebookNavBarViewExampleObject class]])
		{
			for (NSString *key in [[(FacebookNavBarViewExampleObject*)o modules] allKeys])
			{
