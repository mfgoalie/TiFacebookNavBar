...
@interface FacebookNavBarViewExampleObject : KrollCoverageObject {
#else
@interface FacebookNavBarViewExampleObject : KrollObject {
#endif
@private
...
extern NSString * FacebookNavBarViewExample$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FacebookNavBarViewExampleObject *_facebooknavbarviewexample;
	BOOL shutdown;
