...
// in simulator we redefine to format for FacebookNavBarViewExample Developer console
...
{\
	NSString * exceptionName = [@"org.facebooknavbarviewexample." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.facebooknavbarviewexample";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIFacebookNavBarViewExampleNativeItemNone = -1, 
	UIFacebookNavBarViewExampleNativeItemSpinner = -2,
	UIFacebookNavBarViewExampleNativeItemProgressBar = -3,
	
	UIFacebookNavBarViewExampleNativeItemSlider = -4,
	UIFacebookNavBarViewExampleNativeItemSwitch = -5,
	UIFacebookNavBarViewExampleNativeItemMultiButton = -6,
	UIFacebookNavBarViewExampleNativeItemSegmented = -7,
	
	UIFacebookNavBarViewExampleNativeItemTextView = -8,
	UIFacebookNavBarViewExampleNativeItemTextField = -9,
	UIFacebookNavBarViewExampleNativeItemSearchBar = -10,
	
	UIFacebookNavBarViewExampleNativeItemPicker = -11,
	UIFacebookNavBarViewExampleNativeItemDatePicker = -12,
	
	UIFacebookNavBarViewExampleNativeItemInfoLight = -13,
	UIFacebookNavBarViewExampleNativeItemInfoDark = -14,
	
	UIFacebookNavBarViewExampleNativeItemDisclosure = -15,
	
	UIFacebookNavBarViewExampleNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FacebookNavBarViewExample instances of
