...
//Rare exceptions to indicate a bug in the _facebooknavbarviewexample code (Eg, function that a subclass should have implemented)
...
/**
 The base class for FacebookNavBarViewExample proxies.
 */
