...
/**
 The base class for all FacebookNavBarViewExample modules
 */
...
/**
 FacebookNavBarViewExample Platform calls this method on startup.
 */
-(void)startup;

/**
 FacebookNavBarViewExample Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 FacebookNavBarViewExample Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 FacebookNavBarViewExample Platform calls this method on resume.
 @param sender The sender of the event.
 */
